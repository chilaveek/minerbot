...
class Miner(Model):
    ...
    minerstype_iron = IntegerField(default=0)
    minerstype_aurum = IntegerField(default=0)
    minerstype_palladium = IntegerField(default=0)
    ...
    mines_iron = IntegerField(default=0)
    mines_aurum = IntegerField(default=0)
    mines_palladium = IntegerField(default=0)
